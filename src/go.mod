module github.com/DwGoing/MarketBrain

go 1.20

require (
	github.com/alibaba/ioc-golang v1.0.0-rc1
	github.com/alibaba/ioc-golang/extension v0.0.0-20220727065126-278a4e60fdd4
